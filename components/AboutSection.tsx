...
const AboutSection = () => {
  return (
    <div className="bg-white text-black flex flex-col  gap-8 pt-14 pb-10 px-10 ">
      <Title variant="purple">ABOUT</Title>
      <div className="text-center text-lg w-1/2 m-auto">
      ...
      <div className="w-1/2 text-lg text-center m-auto">
